...
public class VegetarianRecipe extends Recipe{
	...
	public void addRecipeWithIngredients()
	{
		...
		{
			System.out.println("Enter the recipe name(Vegetarian): ");
			String rec_name=sc.nextLine();
			System.out.println("Enter the instructions: ");
			String rec_instruction=sc.nextLine();
			
			String query="insert into recipe(recipename,instructions,recipetype) values(?,?,'Vegetarian')";
			...
			System.out.println("Vegetarian Recipe Added Successfully");
		}
